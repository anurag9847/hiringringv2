...
import img1 from '../images/environmental-pollution-factory-exterior-night.jpg';
import img2 from '../images/portrait-elegant-old-man (1).jpg';
            ...
            <div className="flex flex-col lg:flex-row justify-between items-center pt-8">
                ...
                <div className="lg:w-1/2 mb-10 lg:mb-0">
                    <h2 className="text-4xl lg:text-5xl font-bold text-primary text-center lg:text-left mb-10">
                        A Team Of <br></br>Industry<br></br>Veterans
                    </h2>
